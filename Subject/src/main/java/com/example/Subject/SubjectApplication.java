		...
		while(!exitFlag){
			...
			while(true){
				...
				if (option.equalsIgnoreCase("name")){
					...
					patient = new Patient();
					Patient newPatientId = patientRepository.save(patient);
					System.out.println("Making a new user, id: " + newPatientId.getId() + "\n");
					continue;
